...
const Radar = function(size, radar) {
    ...
    return group
      ...
      .attr(
        ...
        "scale(" +
          blipWidth / 34 +
          ") translate(" +
          (-404 + x * (34 / blipWidth) - 17) +
          ", " +
          (-282 + y * (34 / blipWidth) - 17) +
          ")"
      )
      .attr("class", order);
  }
    ...
    return group
      ...
      .attr(
        ...
        "scale(" +
          blipWidth / 64 +
          ") translate(" +
          (-404 + x * (64 / blipWidth) - 17) +
          ", " +
          (-282 + y * (64 / blipWidth) - 17) +
          ")"
      );
  }
  ...
  function thereIsCollision(coordinates, allCoordinates) {
    return allCoordinates.some(function(currentCoordinates) {
      return (
        Math.abs(currentCoordinates[0] - coordinates[0]) < blipWidth &&
        Math.abs(currentCoordinates[1] - coordinates[1]) < blipWidth
      );
    });
  }
  ...
  function plotBlips(quadrantGroup, rings, quadrantWrapper) {
    ...
    rings.forEach(function(ring, i) {
      ...
      ringBlips.forEach(function(blip) {
        ...
        while (
          thereIsCollision(coordinates, allBlipCoordinatesInRing) &&
  ...
  function selectQuadrant(order, startAngle) {
    ...
    d3
      .selectAll(".quadrant-group-" + order + " .blip-link text")
      .each(function() {
